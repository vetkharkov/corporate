<div id="content-single" class="content group">
                    ...
                    <span>
                        <a href="#comments"
                           title="Comment on This is the title of the first article. Enjoy it.">
                            {{ count($article->comments) ? count($article->comments) : '0' }} {{Lang::choice('title.comments',count($article->comments))}}
                        </a>
                    </span>
                </p>
            </div>
    ...
    <div id="comments">
        <h3 id="comments-title">
            ...
            {{ Lang::choice('title.comments',count($article->comments)) }}
        </h3>
    ...
    <!-- START TRACKBACK & PINGBACK -->
        ...
        <div id="respond">
            <h3 id="reply-title">
                ...
                <small>
                    <a rel="nofollow" id="cancel-comment-reply-link" href="#respond" style="display:none;">Cancel
                        reply
                    </a>
                </small>
            </h3>
            <form action="{{ route('comment.store') }}" method="post" id="commentform">
                ...
                @if(!Auth::check())
                    ...
                    <p class="comment-form-url">
                        ...
                        <input id="url" name="site" type="text"
                               value="" size="30"/>
                    </p>
                @endif
