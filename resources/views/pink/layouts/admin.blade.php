...
<head>
    ...
    <!-- JAVASCRIPTs -->
    {{--<script type="text/javascript" src="{{ asset(env('')) }}js/app.js"></script>--}}
        ...
        <div id="header" class="group">
            ...
            <div class="group inner">
                ...
                <div id="logo" class="group">
                    <a href="/" title="logo"><img src="{{ asset(config('settings.theme')) }}/images/logo.png" title="Pink Rio" alt="logo" /></a>
                </div>
                <!-- END LOGO -->
