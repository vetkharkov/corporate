...
jQuery(document).ready(function ($) {
    ...
    $('#commentform').on('click', '#submit', function (e) {
        ...
        e.preventDefault();// Запрет кнопке оправки сообщения обновлять страницу

        var comParent = $(this);//расположение текущей кнопки на которую нажали #submit
