<div class="widget-first widget contact-info">
    ...
    <div class="sidebar-nav">
        <ul>
            <li>
                <i class="icon-map-marker" style="color:#979797;font-size:20pxpx"></i> Location: PinkRio, 115 Avenue
                street - Italy
            </li>
            <li>
...
<div class="widget-last widget text-image">
    ...
    <p>Nunc sit amet pretium purus. Pellet netus et malesuada fames ac turpis egestas.entesque habitant morbi tristique
        senectus </p>
</div>
